...
CREATE TABLE ODS.RESOURCE_TO_REFINED (
  REFINED_RESOURCE_ID NUMBER NOT NULL,
  RAW_RESOURCE_ID  NUMBER NOT NULL,
  PROCESS_DESCRIPTION VARCHAR2(255),

  CREATE_TS           TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  UPDATE_TS           TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,

  CONSTRAINT PK_RESOURCE_REFINED PRIMARY KEY (REFINED_RESOURCE_ID, RAW_RESOURCE_ID),

  CONSTRAINT FK_REFINED_RESOURCE FOREIGN KEY (REFINED_RESOURCE_ID)
    REFERENCES ODS.RESOURCES(RESOURCE_ID),

  CONSTRAINT FK_SOURCE_RESOURCE FOREIGN KEY (RAW_RESOURCE_ID)
    REFERENCES ODS.RESOURCES(RESOURCE_ID)
);

CREATE TABLE ODS.RESOURCE_TO_COMPOSED (
  COMPOSED_RESOURCE_ID NUMBER NOT NULL,
  RESOURCE_SOURCE_1_ID  NUMBER NOT NULL,
  RESOURCE_SOURCE_2_ID  NUMBER NOT NULL,
  RESOURCE_ATMOSPHERIC_ID  NUMBER NOT NULL,
  PROCESS_DESCRIPTION VARCHAR2(255),

  CREATE_TS           TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  UPDATE_TS           TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,

  CONSTRAINT PK_RESOURCE_COMPOSED PRIMARY KEY (COMPOSED_RESOURCE_ID),

  CONSTRAINT FK_COMPOSED_RESOURCE_1 FOREIGN KEY (RESOURCE_SOURCE_1_ID)
    REFERENCES ODS.RESOURCES(RESOURCE_ID),

  CONSTRAINT FK_COMPOSED_RESOURCE_2 FOREIGN KEY (RESOURCE_SOURCE_2_ID)
    REFERENCES ODS.RESOURCES(RESOURCE_ID)
	
  CONSTRAINT FK_ATMOSPHERIC_RESOURCE FOREIGN KEY (RESOURCE_ATMOSPHERIC_ID)
    REFERENCES ODS.RESOURCES(RESOURCE_ID)
);
...
CREATE TABLE ODS.PLANET_NATURAL_RESOURCE (
  ...
  CONSTRAINT FK_LOG_NAT FOREIGN KEY (LOG_ID)
    REFERENCES ODS.ODS_LOG(LOG_ID)
);
